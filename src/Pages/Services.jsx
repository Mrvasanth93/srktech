...
const data = [
    ...
    { "name": "CCTV Installation & service", "desc": "CCTV Camera Install & Service Secure your home or office with CCTV installation and maintenance. High-quality setup, camera configuration, and repair for reliable 24/7 surveillance and peace of mind.", "img": service5 },
    ...
    { "name": "Solar Panel Installation", "desc": "Solar Panel Installation Eco-friendly solar panel setup for homes and businesses. Reduce electricity bills with government-approved solar solutions ensuring high efficiency and long-term energy savings.", "img": service10 }
]
const Services = () => {
    return (
        <>
